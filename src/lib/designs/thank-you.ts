														...
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-left:40px;padding-right:40px;padding-top:20px;">
																<div style="color:#6537a2;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:65px;font-weight:700;line-height:120%;text-align:center;mso-line-height-alt:78px;">
																	<p style="margin: 0;"><strong>Thanks For You Applying</strong></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-left:40px;padding-right:40px;padding-top:15px;">
																<div style="color:#000000;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;line-height:150%;text-align:left;mso-line-height-alt:24px;">
																	<p style="margin: 0;">Hi {{name}},<br><br>Thank you for applying for the job position through our platform. We have received your application and will review it soon.<br><br>If your profile matches our requirements, we’ll reach out to you with further details. We wish you all the best in your job search and thank you for choosing our platform!<br><br>Best regards,<br>The Job Portal Team</p>
																</div>
															</td>
														</tr>
													</table>
